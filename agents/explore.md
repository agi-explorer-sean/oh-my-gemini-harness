...
- **Text patterns** (strings, comments, logs): grep_search
- **File patterns** (find by name/extension): glob
- **History/evolution** (when added, who changed): run_shell_command with git commands
- **Directory structure**: list_directory
