...
// Synced with Gemini's server.ts
// https://github.com/sst/gemini/blob/dev/packages/gemini/src/lsp/server.ts
...
// Synced with Gemini's language.ts
// https://github.com/sst/gemini/blob/dev/packages/gemini/src/lsp/language.ts
export const EXT_TO_LANG: Record<string, string> = {
  ...
  ".kts": "kotlin",
  ".prisma": "prisma",
  // Additional extensions not in Gemini
  ".h": "c",
  ".hpp": "cpp",
  ".hh": "cpp",
  ".hxx": "cpp",
