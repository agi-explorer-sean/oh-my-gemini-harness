...
├── parallel-exec/    # Parallel task orchestration
├── call-omg-agent/   # Direct agent invocation
...
| Agent | delegate_task, call_subagent, parallel_exec | Factory |
...
2.  Use `tool()` from `@gemini-ai-sdk-tool`
