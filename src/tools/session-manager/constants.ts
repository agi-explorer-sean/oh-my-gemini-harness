...
export const SESSION_STORAGE = join(GEMINI_STORAGE, "session")
export const TODO_DIR = join(getClaudeConfigDir(), "todos")
export const TRANSCRIPT_DIR = join(getClaudeConfigDir(), "transcripts")
export const SESSION_LIST_DESCRIPTION = `List all Gemini sessions with optional filtering.
...
export const SESSION_READ_DESCRIPTION = `Read messages and history from an Gemini session.
...
export const SESSION_SEARCH_DESCRIPTION = `Search for content within Gemini session messages.
...
export const SESSION_INFO_DESCRIPTION = `Get metadata and statistics about an Gemini session.
...
export const SESSION_DELETE_DESCRIPTION = `Delete an Gemini session and all associated data.
