...
export const DEFAULT_CATEGORIES: Record<string, CategoryConfig> = {
  ...
  ultrabrain: { model: "google/gemini-3-pro-preview", variant: "max" },
  deep: { model: "google/gemini-3-pro-preview", variant: "medium" },
  ...
  "unspecified-high": { model: "google/gemini-3-pro-preview", variant: "max" },
...
1. Launch background agents to gather context:
   - call_subagent(description="Explore codebase patterns", subagent_type="explore", run_in_background=true, prompt="<search for relevant patterns, files, and implementations in the codebase related to user's request>")
   - call_subagent(description="Research documentation", subagent_type="librarian", run_in_background=true, prompt="<search for external documentation, examples, and best practices related to user's request>")
