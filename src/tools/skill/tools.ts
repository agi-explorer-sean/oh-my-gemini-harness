...
import { getAllSkills, extractSkillTemplate } from "../../features/gemini-skill-loader/skill-content"
import { injectGitMasterConfig } from "../../features/gemini-skill-loader/skill-content"
...
export function createSkillTool(options: SkillLoadOptions & {
