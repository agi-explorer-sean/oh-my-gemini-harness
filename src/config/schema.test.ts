...
describe("disabled_mcps schema", () => {
  test("should accept built-in MCP names", () => {
    ...
    // when
    const result = OhMyGeminiConfigSchema.safeParse(config)
...
describe("OhMyGeminiConfigSchema - browser_automation_engine", () => {
  test("accepts browser_automation_engine config", () => {
    ...
    // when
    const result = OhMyGeminiConfigSchema.safeParse(input)
