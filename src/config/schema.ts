...
export const AgentOverrideConfigSchema = z.object({
  ...
  /** Maximum tokens for response. Passed directly to Gemini SDK. */
  ...
  /** Provider-specific options. Passed directly to Gemini SDK. */
...
export const AgentOverridesSchema = z.object({
  ...
  'Gemini-Builder': AgentOverrideConfigSchema.optional(),
...
export const RalphLoopConfigSchema = z.object({
  ...
  /** Custom state file directory relative to project root (default: .gemini/) */
...
export const NotificationConfigSchema = z.object({
  ...
  /** Enable automatic update checking and notifications (default: true) */
...
export const WebsearchConfigSchema = z.object({
  /** Web search provider: exa (default), tavily, or serper */
  provider: z.enum(['exa', 'tavily', 'serper']).default('exa'),
});

export type WebsearchConfig = z.infer<typeof WebsearchConfigSchema>;

export const OhMyGeminiConfigSchema = z.object({
  $schema: z.string().optional(),
  /** Enable new task system (default: false) */
  new_task_system_enabled: z.boolean().optional(),
  /** Default agent name for `oh-my-gemini run` (env: GEMINI_DEFAULT_AGENT) */
  default_run_agent: z.string().optional(),
  /** Default agent for interactive sessions (injected via system_note when no @agent is specified) */
...
export type OhMyGeminiConfig = z.infer<typeof OhMyGeminiConfigSchema>;
