...
// Use spyOn for McpOAuthProvider instead of mock.module
spyOn(McpOAuthProvider.prototype, 'tokens').mockImplementation(mockTokens);
spyOn(McpOAuthProvider.prototype, 'login').mockImplementation(mockLogin);
