...
describe('listTaskFiles', () => {
  ...
  test('returns empty array for non-existent directory', () => {
    ...
    const config: Partial<OhMyGeminiConfig> = {
      ...
      sisyphus: {tasks: {storage_path: TEST_DIR, gemini_code_compat: false}},
    };
