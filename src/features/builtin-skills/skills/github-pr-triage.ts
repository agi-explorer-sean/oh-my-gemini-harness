...
export const githubPrTriageSkill: BuiltinSkill = {
  ...
  template: `# GitHub PR Triage Specialist (Streaming Architecture)
...
\`\`\`bash
python3 src/features/builtin-skills/scripts/gh_fetch.py prs --output json
\`\`\`
