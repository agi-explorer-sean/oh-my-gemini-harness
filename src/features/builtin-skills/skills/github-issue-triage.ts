...
export const githubIssueTriageSkill: BuiltinSkill = {
  ...
  template: `# GitHub Issue Triage Specialist (Streaming Architecture)
...
python3 src/features/builtin-skills/scripts/gh_fetch.py issues --hours 48 --output json

# Custom time range
python3 src/features/builtin-skills/scripts/gh_fetch.py issues --hours 72 --output json
\`\`\`
