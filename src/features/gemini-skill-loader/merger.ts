...
function builtinToLoaded(builtin: BuiltinSkill): LoadedSkill {
  const definition: CommandDefinition = {
    name: builtin.name,
    description: `(gemini - Skill) ${builtin.description}`,
...
$ARGUMENTS
  ...
  const definition: CommandDefinition = {
    ...
    model: sanitizeModelField(entry.model || fileMetadata.model, "gemini"),
...
export function mergeSkills(
  ...
  userGeminiSkills: LoadedSkill[],
  projectClaudeSkills: LoadedSkill[],
  projectGeminiSkills: LoadedSkill[],
